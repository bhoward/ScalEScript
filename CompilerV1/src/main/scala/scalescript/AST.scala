...
case class AssignExpr(lhs: Expr, op: String, rhs: Expr) extends Expr
...
case class AnnotAssignExpr(lhs: AnnotExpr, op: String, rhs: AnnotExpr) extends AnnotExpr with Tableless
...
case class TypedAssignExpr(lhs: TypedExpr, op: String, rhs: TypedExpr, override val evalType: Type) extends TypedExpr with Tableless
